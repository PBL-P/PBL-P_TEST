import { FaProjectDiagram, FaFileAlt, FaClipboardList, FaCog, FaSearch, FaBell, FaCalendarAlt} from 'react-icons/fa';
...
export const menuData = [
  ...
  { id: 7, label: '공지사항', icon: <FaBell />, route: '/announcement', activeColor: '#dc3545', }
];
